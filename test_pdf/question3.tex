...
\question[30] A design point on the root-locus plot for a P-type controller is shown below. A zero is added so that the root-locus passes through this design point. Which of the following represents the correct angle condition for this design?
\begin{figure}[!htb]
  \centering
