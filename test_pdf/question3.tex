...
\pgfmathsetmacro{\zeta}{0.5+(0.6-0.5)*(10*\xone+\xzero)/99}

\pgfmathsetmacro{\sigmad}{\pZero+\pOne}
\pgfmathsetmacro{\wn}{\sigmad/\zeta}
\pgfmathsetmacro{\omegad}{\wn*sqrt(1-\zeta^2)} 

\pgfmathsetmacro{\kVal}{2*\zeta*\wn-\pOne-\pZero} 
...
\centering
\ifprintanswers
  \pgfmathsetmacro{\angleSum}{\angleZero+\angleOne+\anglezValComp}
  $\sum\theta =\pgfmathprintnumber[precision=1]{\angleSum}^\circ$ 
\fi
\begin{tikzpicture}
  \begin{axis}[
